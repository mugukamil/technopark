 ...
 */
function technopark_custom_colors_css() {
     ...
     */
    $saturation = absint( apply_filters( 'technopark_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.technopark-front-page) .entry-title,
...
.colors-custom .technopark-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.technopark-front-page .panel-content .recent-posts article,
...
.colors-custom.technopark-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
     ...
     */
    return apply_filters( 'technopark_custom_colors_css', $css, $hue, $saturation );
}
