...
<aside class="sidebar content__sidebar">
	<div class="sidebar__in">
		<div class="content__news news sidebar__content">
			<h1 class="news__heading sidebar__heading">IMMOBILIEN SUCHE</h1>
			<form class="search__filter">
				<label class="search__container">wohnung
					<input type="checkbox">
					<span class="checkmark"></span>
				</label>
				<label class="search__container">gewerbeimmobilie
					<input type="checkbox">
					<span class="checkmark"></span>
				</label>
			</form>
			<div class="search__btn__wrapper">
				<button class="search__btn">// SUCHEN</button>
			</div>
