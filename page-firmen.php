<?php
/**
 * Template Name: Firmengruppe Page
...
<!--         <div class="sidebar__bg"></div> -->
        <?php //get_template_part('template-parts/header/header1'); ?>

        <div class="content__bg"><?php the_post_thumbnail() ?></div>
        <div class="container">
          <div class="row">
            <div class="cols companies">
            <?php
